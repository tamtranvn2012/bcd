...
class EC_DB {
	...
	function initOptions() {
		...
		if (!isset($options['accessLevel'])){
        
        //tuy bien 
        if(get_option('default_role')=="administrator") $options['accessLevel'] = 'level_10';
        if(get_option('default_role')=="editor") $options['accessLevel'] = 'level_7';
        if(get_option('default_role')=="author") $options['accessLevel'] = 'level_2';
        if(get_option('default_role')=="contributor")$options['accessLevel'] = 'level_1';
        if(get_option('default_role')=="subscriber")$options['accessLevel'] = 'level_0';
        }
