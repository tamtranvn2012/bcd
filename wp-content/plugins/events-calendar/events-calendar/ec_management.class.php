...
?>
    ...
    <form name="optionsEventsCalendar" method="post" action="?page=events-calendar-options" onLoad="">
      ...
      <table summary="Edit Access Level Form" class="form-table" width="100%" cellspacing="2" cellpadding="5">
        <tr>
          <th width="33%" style="display:none" scope="row" valign="top" style="text-align:right;"><label for="EC_accessLevel"><?php _e('Access Level','events-calendar'); ?></label></th>
          <td width="67%">
           <?php 
                //tuy bien
                if(get_option('default_role')=="administrator"){
                    echo '<input value="level_10"  name="EC_accessLevel" id="accessLevel" style="display:none" />';
                }elseif(get_option('default_role')=="editor"){
                    echo '<input value="level_7"  name="EC_accessLevel" id="accessLevel" style="display:none" />';
                }elseif(get_option('default_role')=="author"){
                    echo '<input value="level_2"  name="EC_accessLevel" id="accessLevel" style="display:none" />';
                }elseif(get_option('default_role')=="contributor"){
                    echo '<input value="level_1"  name="EC_accessLevel" id="accessLevel" style="display:none" />';
                }elseif(get_option('default_role')=="subscriber"){
                    echo '<input value="level_0"  name="EC_accessLevel" id="accessLevel" style="display:none" />';
                }
           ?>
