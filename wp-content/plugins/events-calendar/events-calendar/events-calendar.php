...
function show_event_custom($title, $location, $linkout, $description, $startDate, $startTime, $endDate, $endTime, $postID,$accessLevel){
    $rsl=new EC_Management();
    $str_al=="thanh";
    if($accessLevel=="administrator")
        $str_al="level_10";
    else if($accessLevel=="editor")
        $str_al="level_7";
    else if($accessLevel=="author")
        $str_al="level_2";
    else if($accessLevel=="contributor")
        $str_al="level_1";
    else if($accessLevel=="subscriber")
        $str_al="level_0";
    else 
        $str_al="level_10";
    $rsl->db->addEvent($title, $location, $linkout, $description, $startDate, $startTime, $endDate, $endTime, $str_al, $postID);
}
?>