			...
			<thead>
				...
				<tbody>
					...
					<tr>  
						...
						<td id="manage-columnCell"> 
							<input type="radio" name="wppb_default_settings[nicknameRequired]" value="yes" checked /><font size="1"><?php _e('Yes', 'profilebuilder');?></font><span style="padding-left:20px"></span>
							<input type="radio" name="wppb_default_settings[nicknameRequired]" value="no" disabled /><font size="1" color="grey"><?php _e('No', 'profilebuilder');?></font>
						</td> 						
					</tr>
					<tr>  
						<td id="manage-columnCell"> 
