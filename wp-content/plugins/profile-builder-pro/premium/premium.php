...
<?php
	...
	function register_profile_builder(){
?>
		...
		<input type="password" size="50" name="wppb_profile_builder_pro_serial" id="wppb_profile_builder_pro_serial" <?php if ( $wppb_profile_builder_pro_serial != ''){ echo ' value="'.$wppb_profile_builder_pro_serial.'"';} ?>/>
		<?php 
			$serial_number_availability = get_option('serial_number_availability');
			if ($serial_number_availability == 'notFound')
				echo '<span class="validateStatus"><img src="'.WPPB_PLUGIN_URL.'/assets/images/icon_error.png" title="'.__('The serial number couldn\'t be validated or isn\'t valid!','profilebuilder').'"/></span>';
			elseif($serial_number_availability == 'found')
