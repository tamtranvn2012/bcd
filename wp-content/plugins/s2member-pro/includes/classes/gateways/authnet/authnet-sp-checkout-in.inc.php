														...
														if (($sp_access_url = c_ws_plugin__s2member_sp_access::sp_access_link_gen ($post_vars["attr"]["ids"], $post_vars["attr"]["exp"])))
															{
																...
																/**/
																$global_response = array ("response" => '<strong>Thank you.</strong> Your purchase has been approved.<br />&mdash; Please <a href="' . esc_attr ($sp_access_url) . '" rel="nofollow">click here</a> to proceed.');
																/**/
															...
															{
																$global_response = array ("response" => 'Unable to generate Access Link. Please contact Support for assistance.', "error" => true);
															}
													}
												else /* Else, an error. */
													{
