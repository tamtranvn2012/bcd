																		...
																		if (($authnet = c_ws_plugin__s2member_pro_authnet_utilities::authnet_arb_response ($authnet)) && empty ($authnet["__error"]))
																			{
																				...
																				&& wp_redirect (c_ws_plugin__s2member_pro_authnet_utilities::authnet_s2p_v_generate ($custom_success_url)) !== "nill") /* Also generate an s2p-v variable; used for verification. */
																					exit ();
																			}
																		else /* Else, an error. */
																			{
