...
if (!function_exists ("s2member_pro_paypal_s2p_v_query_ok"))
	{
		function s2member_pro_paypal_s2p_v_query_ok ($qs = FALSE, $ignore_timestamp = FALSE)
			{
				return c_ws_plugin__s2member_pro_paypal_utilities::paypal_s2p_v_query_ok ($qs, $ignore_timestamp);
			}
	}
?>