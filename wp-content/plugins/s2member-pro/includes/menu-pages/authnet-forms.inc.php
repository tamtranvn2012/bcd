				...
				public function __construct ()
					{
						...
						$ws_plugin__s2member_pro_temp_s = trim (file_get_contents (dirname (dirname (__FILE__)) . "/templates/shortcodes/authnet-registration-form-shortcode.html"));
						...
						for ($n = 1; $n <= $GLOBALS["WS_PLUGIN__"]["s2member"]["c"]["levels"]; $n++)
							{
								...
								echo '<td>' . "\n";
								echo '<form onsubmit="return false;">' . "\n";
								echo '<p id="ws-plugin--s2member-pro-level' . $n . '-trial-line">I\'ll offer the first <input type="text" id="ws-plugin--s2member-pro-level' . $n . '-trial-period" value="0" size="6" /> <select id="ws-plugin--s2member-pro-level' . $n . '-trial-term">' . file_get_contents (dirname (dirname (__FILE__)) . "/templates/options/authnet-membership-trial-terms.html") . '</select> @ $<input type="text" id="ws-plugin--s2member-pro-level' . $n . '-trial-amount" value="0.00" size="4" /></p>' . "\n";
								echo '<p><span id="ws-plugin--s2member-pro-level' . $n . '-trial-then">Then, </span>I want to charge: $<input type="text" id="ws-plugin--s2member-pro-level' . $n . '-amount" value="0.01" size="4" /> / <select id="ws-plugin--s2member-pro-level' . $n . '-term">' . file_get_contents (dirname (dirname (__FILE__)) . "/templates/options/authnet-membership-regular-terms.html") . '</select></p>' . "\n";
								...
								echo '<p>Currency: <select id="ws-plugin--s2member-pro-level' . $n . '-currency">' . file_get_contents (dirname (dirname (__FILE__)) . "/templates/options/authnet-currencies.html") . '</select> <input type="button" value="Generate Form Code" onclick="ws_plugin__s2member_pro_authnetFormGenerate(\'level' . $n . '\');" class="button-primary" /></p>' . "\n";
								...
								echo '<form onsubmit="return false;">' . "\n";
								echo '<strong>WordPress® Shortcode:</strong> ( recommended for both the WordPress® Visual &amp; HTML Editors )<br />' . "\n";
								$ws_plugin__s2member_pro_temp_s = trim (file_get_contents (dirname (dirname (__FILE__)) . "/templates/shortcodes/authnet-checkout-form-shortcode.html"));
						...
						echo '</select></p>' . "\n";
						/**/
						echo '<p id="ws-plugin--s2member-pro-modification-trial-line">I\'ll offer the first <input type="text" id="ws-plugin--s2member-pro-modification-trial-period" value="0" size="6" /> <select id="ws-plugin--s2member-pro-modification-trial-term">' . file_get_contents (dirname (dirname (__FILE__)) . "/templates/options/authnet-membership-trial-terms.html") . '</select> @ $<input type="text" id="ws-plugin--s2member-pro-modification-trial-amount" value="0.00" size="4" /></p>' . "\n";
						echo '<p><span id="ws-plugin--s2member-pro-modification-trial-then">Then, </span>I want to charge: $<input type="text" id="ws-plugin--s2member-pro-modification-amount" value="0.01" size="4" /> / <select id="ws-plugin--s2member-pro-modification-term">' . file_get_contents (dirname (dirname (__FILE__)) . "/templates/options/authnet-membership-regular-terms.html") . '</select></p>' . "\n";
						...
						echo '<p>Currency: <select id="ws-plugin--s2member-pro-modification-currency">' . file_get_contents (dirname (dirname (__FILE__)) . "/templates/options/authnet-currencies.html") . '</select> <input type="button" value="Generate Form Code" onclick="ws_plugin__s2member_pro_authnetFormGenerate(\'modification\');" class="button-primary" /></p>' . "\n";
						...
						if (!is_multisite () || !c_ws_plugin__s2member_utils_conds::is_multisite_farm () || is_main_site ())
							{
								...
								echo '<form onsubmit="return false;">' . "\n";
								/**/
								echo '<p>I want to charge: $<input type="text" id="ws-plugin--s2member-pro-ccap-amount" value="0.01" size="4" /> / <select id="ws-plugin--s2member-pro-ccap-term">' . file_get_contents (dirname (dirname (__FILE__)) . "/templates/options/authnet-membership-ccap-terms.html") . '</select></p>' . "\n";
								...
								echo '<p>Currency: <select id="ws-plugin--s2member-pro-ccap-currency">' . file_get_contents (dirname (dirname (__FILE__)) . "/templates/options/authnet-currencies.html") . '</select> <input type="button" value="Generate Form Code" onclick="ws_plugin__s2member_pro_authnetCcapFormGenerate();" class="button-primary" /></p>' . "\n";
								...
								echo '<form onsubmit="return false;">' . "\n";
								echo '<strong>WordPress® Shortcode:</strong> ( recommended for both the WordPress® Visual &amp; HTML Editors )<br />' . "\n";
								$ws_plugin__s2member_pro_temp_s = trim (file_get_contents (dirname (dirname (__FILE__)) . "/templates/shortcodes/authnet-ccaps-checkout-form-shortcode.html"));
								$ws_plugin__s2member_pro_temp_s = preg_replace ("/%%custom%%/", c_ws_plugin__s2member_utils_strings::esc_ds (esc_attr ($_SERVER["HTTP_HOST"])), $ws_plugin__s2member_pro_temp_s);
						...
						echo '<form onsubmit="return false;">' . "\n";
						echo '<strong>WordPress® Shortcode:</strong> ( recommended for both the WordPress® Visual &amp; HTML Editors )<br />' . "\n";
						$ws_plugin__s2member_pro_temp_s = trim (file_get_contents (dirname (dirname (__FILE__)) . "/templates/shortcodes/authnet-update-form-shortcode.html"));
						...
						echo '<form onsubmit="return false;">' . "\n";
						echo '<strong>WordPress® Shortcode:</strong> ( recommended for both the WordPress® Visual &amp; HTML Editors )<br />' . "\n";
						$ws_plugin__s2member_pro_temp_s = trim (file_get_contents (dirname (dirname (__FILE__)) . "/templates/shortcodes/authnet-cancellation-form-shortcode.html"));
						...
						/**/
						echo '<p>I want to charge: $<input type="text" id="ws-plugin--s2member-pro-sp-amount" value="0.01" size="4" /> / <select id="ws-plugin--s2member-pro-sp-hours">' . file_get_contents (dirname (dirname (__FILE__)) . "/templates/options/authnet-sp-hours.html") . '</select></p>' . "\n";
						...
						echo '<p>Currency: <select id="ws-plugin--s2member-pro-sp-currency">' . file_get_contents (dirname (dirname (__FILE__)) . "/templates/options/authnet-currencies.html") . '</select> <input type="button" value="Generate Form Code" onclick="ws_plugin__s2member_pro_authnetSpFormGenerate();" class="button-primary" /></p>' . "\n";
						echo '</form>' . "\n";
						echo '</td>' . "\n";
						/**/
						echo '</tr>' . "\n";
						...
						echo '<form onsubmit="return false;">' . "\n";
						echo '<strong>WordPress® Shortcode:</strong> ( recommended for both the WordPress® Visual &amp; HTML Editors )<br />' . "\n";
						$ws_plugin__s2member_pro_temp_s = trim (file_get_contents (dirname (dirname (__FILE__)) . "/templates/shortcodes/authnet-sp-checkout-form-shortcode.html"));
						$ws_plugin__s2member_pro_temp_s = preg_replace ("/%%custom%%/", c_ws_plugin__s2member_utils_strings::esc_ds (esc_attr ($_SERVER["HTTP_HOST"])), $ws_plugin__s2member_pro_temp_s);
						...
						echo '</optgroup></select> <a href="#" onclick="alert(\'Hold down your `Ctrl` key to select multiples.\\n\\nOptional. If you include Additional Posts/Pages, Customers will still land on your Leading Post/Page; BUT, they\\\'ll ALSO have access to some Additional Posts/Pages that you\\\'ve protected. This gives you the ability to create Post/Page Packages.\\n\\nIn other words, a Customer is sold a Specific Post/Page ( they\\\'ll land on your Leading Post/Page after checkout ), which might contain links to some other Posts/Pages that you\\\'ve packaged together under one transaction.\\n\\nBundling Additional Posts/Pages into one Package, authenticates the Customer for access to the Additional Posts/Pages automatically ( e.g. only one Access Link is needed, and s2Member generates this automatically ). However, you will STILL need to design your Leading Post/Page ( which is what a Customer will actually land on ), with links pointing to the other Posts/Pages. This way your Customers will have clickable links to everything they\\\'ve paid for.\\n\\n*Quick Summary* s2Member sends Customers to your Leading Post/Page, and also authenticates them for access to any Additional Posts/Pages automatically. You handle it from there.\\n\\n*Tip* If there are no Posts/Pages in this menu, it\\\'s because you\\\'ve not configured s2Member for Specific Post/Page Access yet. See: s2Member -> Restriction Options -> Specific Post/Page Access.\'); return false;" tabindex="-1">[?]</a></p>' . "\n";
						/**/
						echo '<p><select id="ws-plugin--s2member-pro-sp-link-hours">' . file_get_contents (dirname (dirname (__FILE__)) . "/templates/options/authnet-sp-hours.html") . '</select> <input type="button" value="Generate Access Link" onclick="ws_plugin__s2member_pro_authnetSpLinkGenerate();" class="button-primary" /> <img id="ws-plugin--s2member-pro-sp-link-loading" src="' . esc_attr ($GLOBALS["WS_PLUGIN__"]["s2member"]["c"]["dir_url"]) . '/images/ajax-loader.gif" alt="" style="display:none;" /></p>' . "\n";
						...
						if (!is_multisite () || !c_ws_plugin__s2member_utils_conds::is_multisite_farm () || is_main_site ())
							{
								...
								echo '<p>' . c_ws_plugin__s2member_utils_strings::highlight_php (file_get_contents (dirname (__FILE__) . "/code-samples/authnet-s2p-v-query-ok-1.php")) . '</p>' . "\n";
								...
								echo '<p>' . c_ws_plugin__s2member_utils_strings::highlight_php (file_get_contents (dirname (__FILE__) . "/code-samples/authnet-s2p-v-query-ok-2.php")) . '</p>' . "\n";
								/**/
								echo '<div class="ws-menu-page-hr"></div>' . "\n";
								/**/
