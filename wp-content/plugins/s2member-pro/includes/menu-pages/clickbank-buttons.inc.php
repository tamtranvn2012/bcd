				...
				public function __construct ()
					{
						...
						for ($n = 1; $n <= $GLOBALS["WS_PLUGIN__"]["s2member"]["c"]["levels"]; $n++)
							{
								...
								echo '<p>ClickBank® Product Type: <select id="ws-plugin--s2member-pro-level' . $n . '-type">' . file_get_contents (dirname (dirname (__FILE__)) . "/templates/options/clickbank-product-types.html") . '</select>' . "\n";
								echo '<p>ClickBank® Product Item #: <input type="text" id="ws-plugin--s2member-pro-level' . $n . '-item-number" value="" size="5" /> <a href="#" onclick="alert(\'This MUST correlate with a Product that you\\\'ve configured in your ClickBank® account.\'); return false;" tabindex="-1">[?]</a> &nbsp;&nbsp;&nbsp; <input type="button" value="Generate Button Code" onclick="ws_plugin__s2member_pro_clickbankButtonGenerate(\'level' . $n . '\');" class="button-primary" /></p>' . "\n";
								echo '<p id="ws-plugin--s2member-pro-level' . $n . '-term-line">Fixed-Term Access: <select id="ws-plugin--s2member-pro-level' . $n . '-term">' . file_get_contents (dirname (dirname (__FILE__)) . "/templates/options/clickbank-fixed-terms.html") . '</select> <a href="#" onclick="alert(\'For Standard Products, a Fixed-Term allows s2Member to configure the Auto-EOT ( End Of Term ) Time after checkout is completed through ClickBank®.\'); return false;" tabindex="-1">[?]</a></p>' . "\n";
								echo '<p id="ws-plugin--s2member-pro-level' . $n . '-periods-line">ClickBank® Trial Period: <select id="ws-plugin--s2member-pro-level' . $n . '-p1">' . file_get_contents (dirname (dirname (__FILE__)) . "/templates/options/clickbank-trial-p1s.html") . '</select>, then Re-Bill: <select id="ws-plugin--s2member-pro-level' . $n . '-p3">' . file_get_contents (dirname (dirname (__FILE__)) . "/templates/options/clickbank-regular-p3s.html") . '</select> <a href="#" onclick="alert(\'This MUST correlate with a Product that you\\\'ve configured in your ClickBank® account.\'); return false;" tabindex="-1">[?]</a></p>' . "\n";
								echo '<p>Description: <input type="text" id="ws-plugin--s2member-pro-level' . $n . '-desc" value="' . format_to_edit ($GLOBALS["WS_PLUGIN__"]["s2member"]["o"]["level" . $n . "_label"]) . ' / description and pricing details here." size="70" /> <a href="#" onclick="alert(\'This can be worded however you like. It does NOT need to be an exact match to the Product in your ClickBank® account.\'); return false;" tabindex="-1">[?]</a></p>' . "\n";
								...
								$ws_plugin__s2member_pro_temp_s = trim (file_get_contents (dirname (dirname (__FILE__)) . "/templates/shortcodes/clickbank-checkout-button-shortcode.html"));
								...
								echo '<strong>Resulting ClickBank® Button Code:</strong> ( ultimately, your Shortcode will produce this snippet )<br />' . "\n";
								echo '<textarea id="ws-plugin--s2member-pro-level' . $n . '-button" rows="8" wrap="off" onclick="this.select ();" style="font-family:Consolas, monospace; width:99%;">';
								$ws_plugin__s2member_pro_temp_s = trim (file_get_contents (dirname (dirname (__FILE__)) . "/templates/buttons/clickbank-checkout-button.html"));
								$ws_plugin__s2member_pro_temp_s = preg_replace ("/%%item%%/", c_ws_plugin__s2member_utils_strings::esc_ds (esc_attr ("0")), $ws_plugin__s2member_pro_temp_s);
								$ws_plugin__s2member_pro_temp_s = preg_replace ("/%%vendor%%/", c_ws_plugin__s2member_utils_strings::esc_ds (esc_attr ($GLOBALS["WS_PLUGIN__"]["s2member"]["o"]["pro_clickbank_username"])), $ws_plugin__s2member_pro_temp_s);
								$ws_plugin__s2member_pro_temp_s = preg_replace ("/%%invoice%%/", c_ws_plugin__s2member_utils_strings::esc_ds (esc_attr (urlencode ($n))), $ws_plugin__s2member_pro_temp_s);
								$ws_plugin__s2member_pro_temp_s = preg_replace ("/%%p1%%/", c_ws_plugin__s2member_utils_strings::esc_ds (esc_attr (urlencode ("0 D"))), $ws_plugin__s2member_pro_temp_s);
								$ws_plugin__s2member_pro_temp_s = preg_replace ("/%%p3%%/", c_ws_plugin__s2member_utils_strings::esc_ds (esc_attr (urlencode ("1 M"))), $ws_plugin__s2member_pro_temp_s);
								$ws_plugin__s2member_pro_temp_s = preg_replace ("/%%desc%%/", c_ws_plugin__s2member_utils_strings::esc_ds (esc_attr (urlencode ($GLOBALS["WS_PLUGIN__"]["s2member"]["o"]["level" . $n . "_label"]))), $ws_plugin__s2member_pro_temp_s);
								$ws_plugin__s2member_pro_temp_s = preg_replace ("/%%custom%%/", c_ws_plugin__s2member_utils_strings::esc_ds (esc_attr (urlencode ($_SERVER["HTTP_HOST"]))), $ws_plugin__s2member_pro_temp_s);
								$ws_plugin__s2member_pro_temp_s = preg_replace ("/%%referencing%%/", c_ws_plugin__s2member_utils_strings::esc_ds (esc_attr (urlencode (""))), $ws_plugin__s2member_pro_temp_s);
								...
								echo format_to_edit ($ws_plugin__s2member_pro_temp_s);
								echo '</textarea><br />' . "\n";
						...
						$ws_plugin__s2member_pro_temp_s = trim (file_get_contents (dirname (dirname (__FILE__)) . "/templates/buttons/clickbank-cancellation-button.html"));
						$ws_plugin__s2member_pro_temp_s = preg_replace ("/%%images%%/", c_ws_plugin__s2member_utils_strings::esc_ds (esc_attr ($GLOBALS["WS_PLUGIN__"]["s2member_pro"]["c"]["dir_url"] . "/images")), $ws_plugin__s2member_pro_temp_s);
						$ws_plugin__s2member_pro_temp_s = preg_replace ("/%%wpurl%%/", c_ws_plugin__s2member_utils_strings::esc_ds (esc_attr (site_url ())), $ws_plugin__s2member_pro_temp_s);
						$ws_plugin__s2member_pro_temp_s = preg_replace ("/&amp;/", "&", $ws_plugin__s2member_pro_temp_s); /* Match this with the JavaScript generator. */
						...
						echo '<form onsubmit="return false;">' . "\n";
						echo '<strong>WordPress® Shortcode:</strong> ( recommended for both the WordPress® Visual &amp; HTML Editors )<br />' . "\n";
						$ws_plugin__s2member_pro_temp_s = trim (file_get_contents (dirname (dirname (__FILE__)) . "/templates/shortcodes/clickbank-cancellation-button-shortcode.html"));
						...
						echo '<div' . ((is_multisite () && c_ws_plugin__s2member_utils_conds::is_multisite_farm () && !is_main_site ()) ? ' style="display:none;"' : '') . '><br />' . "\n";
						echo '<strong>Resulting ClickBank® Button Code:</strong> ( ultimately, your Shortcode will produce this snippet )<br />' . "\n";
						echo '<textarea id="ws-plugin--s2member-pro-cancellation-button" rows="8" wrap="off" onclick="this.select ();" style="font-family:Consolas, monospace; width:99%;">';
						$ws_plugin__s2member_pro_temp_s = trim (file_get_contents (dirname (dirname (__FILE__)) . "/templates/buttons/clickbank-cancellation-button.html"));
						$ws_plugin__s2member_pro_temp_s = preg_replace ("/%%images%%/", c_ws_plugin__s2member_utils_strings::esc_ds (esc_attr ($GLOBALS["WS_PLUGIN__"]["s2member_pro"]["c"]["dir_url"] . "/images")), $ws_plugin__s2member_pro_temp_s);
						$ws_plugin__s2member_pro_temp_s = preg_replace ("/%%wpurl%%/", c_ws_plugin__s2member_utils_strings::esc_ds (esc_attr (site_url ())), $ws_plugin__s2member_pro_temp_s);
						$ws_plugin__s2member_pro_temp_s = preg_replace ("/&amp;/", "&", $ws_plugin__s2member_pro_temp_s); /* Match this with the JavaScript generator. */
						...
						echo '<td>' . "\n";
						echo '<form onsubmit="return false;">' . "\n";
						echo '<p>ClickBank® Product Item #: <input type="text" id="ws-plugin--s2member-pro-sp-item-number" value="" size="5" /> <a href="#" onclick="alert(\'This MUST correlate with a Product that you\\\'ve configured in your ClickBank® account.\'); return false;" tabindex="-1">[?]</a></p>' . "\n";
						echo '<p><select id="ws-plugin--s2member-pro-sp-hours">' . file_get_contents (dirname (dirname (__FILE__)) . "/templates/options/clickbank-sp-hours.html") . '</select></p>' . "\n";
						/**/
						...
						/**/
						echo '<p><input type="text" id="ws-plugin--s2member-pro-sp-desc" value="Description and pricing details here." size="67" /> <a href="#" onclick="alert(\'This can be worded however you like. It does NOT need to be an exact match to the Product in your ClickBank® account.\'); return false;" tabindex="-1">[?]</a></p>' . "\n";
						...
						echo '<form onsubmit="return false;">' . "\n";
						echo '<strong>WordPress® Shortcode:</strong> ( recommended for both the WordPress® Visual &amp; HTML Editors )<br />' . "\n";
						$ws_plugin__s2member_pro_temp_s = trim (file_get_contents (dirname (dirname (__FILE__)) . "/templates/shortcodes/clickbank-sp-checkout-button-shortcode.html"));
						$ws_plugin__s2member_pro_temp_s = preg_replace ("/%%item%%/", c_ws_plugin__s2member_utils_strings::esc_ds (esc_attr ("0")), $ws_plugin__s2member_pro_temp_s);
						$ws_plugin__s2member_pro_temp_s = preg_replace ("/%%custom%%/", c_ws_plugin__s2member_utils_strings::esc_ds (esc_attr ($_SERVER["HTTP_HOST"])), $ws_plugin__s2member_pro_temp_s);
						...
						echo '<div' . ((is_multisite () && c_ws_plugin__s2member_utils_conds::is_multisite_farm () && !is_main_site ()) ? ' style="display:none;"' : '') . '><br />' . "\n";
						echo '<strong>Resulting ClickBank® Button Code:</strong> ( ultimately, your Shortcode will produce this snippet )<br />' . "\n";
						echo '<textarea id="ws-plugin--s2member-pro-sp-button" rows="8" wrap="off" onclick="this.select ();" style="font-family:Consolas, monospace; width:99%;">';
						$ws_plugin__s2member_pro_temp_s = trim (file_get_contents (dirname (dirname (__FILE__)) . "/templates/buttons/clickbank-sp-checkout-button.html"));
						$ws_plugin__s2member_pro_temp_s = preg_replace ("/%%item%%/", c_ws_plugin__s2member_utils_strings::esc_ds (esc_attr ("0")), $ws_plugin__s2member_pro_temp_s);
						$ws_plugin__s2member_pro_temp_s = preg_replace ("/%%vendor%%/", c_ws_plugin__s2member_utils_strings::esc_ds (esc_attr ($GLOBALS["WS_PLUGIN__"]["s2member"]["o"]["pro_clickbank_username"])), $ws_plugin__s2member_pro_temp_s);
						$ws_plugin__s2member_pro_temp_s = preg_replace ("/%%invoice%%/", c_ws_plugin__s2member_utils_strings::esc_ds (esc_attr (urlencode ("0"))), $ws_plugin__s2member_pro_temp_s);
						$ws_plugin__s2member_pro_temp_s = preg_replace ("/%%custom%%/", c_ws_plugin__s2member_utils_strings::esc_ds (esc_attr (urlencode ($_SERVER["HTTP_HOST"]))), $ws_plugin__s2member_pro_temp_s);
						$ws_plugin__s2member_pro_temp_s = preg_replace ("/%%referencing%%/", c_ws_plugin__s2member_utils_strings::esc_ds (esc_attr (urlencode (""))), $ws_plugin__s2member_pro_temp_s);
						$ws_plugin__s2member_pro_temp_s = preg_replace ("/%%images%%/", c_ws_plugin__s2member_utils_strings::esc_ds (esc_attr ($GLOBALS["WS_PLUGIN__"]["s2member_pro"]["c"]["dir_url"] . "/images")), $ws_plugin__s2member_pro_temp_s);
						$ws_plugin__s2member_pro_temp_s = preg_replace ("/%%wpurl%%/", c_ws_plugin__s2member_utils_strings::esc_ds (esc_attr (site_url ())), $ws_plugin__s2member_pro_temp_s);
						...
						echo '</optgroup></select> <a href="#" onclick="alert(\'Hold down your `Ctrl` key to select multiples.\\n\\nOptional. If you include Additional Posts/Pages, Customers will still land on your Leading Post/Page; BUT, they\\\'ll ALSO have access to some Additional Posts/Pages that you\\\'ve protected. This gives you the ability to create Post/Page Packages.\\n\\nIn other words, a Customer is sold a Specific Post/Page ( they\\\'ll land on your Leading Post/Page after checkout ), which might contain links to some other Posts/Pages that you\\\'ve packaged together under one transaction.\\n\\nBundling Additional Posts/Pages into one Package, authenticates the Customer for access to the Additional Posts/Pages automatically ( e.g. only one Access Link is needed, and s2Member generates this automatically ). However, you will STILL need to design your Leading Post/Page ( which is what a Customer will actually land on ), with links pointing to the other Posts/Pages. This way your Customers will have clickable links to everything they\\\'ve paid for.\\n\\n*Quick Summary* s2Member sends Customers to your Leading Post/Page, and also authenticates them for access to any Additional Posts/Pages automatically. You handle it from there.\\n\\n*Tip* If there are no Posts/Pages in this menu, it\\\'s because you\\\'ve not configured s2Member for Specific Post/Page Access yet. See: s2Member -> Restriction Options -> Specific Post/Page Access.\'); return false;" tabindex="-1">[?]</a></p>' . "\n";
						/**/
						echo '<p><select id="ws-plugin--s2member-pro-sp-link-hours">' . file_get_contents (dirname (dirname (__FILE__)) . "/templates/options/clickbank-sp-hours.html") . '</select> <input type="button" value="Generate Access Link" onclick="ws_plugin__s2member_pro_clickbankSpLinkGenerate();" class="button-primary" /> <img id="ws-plugin--s2member-pro-sp-link-loading" src="' . esc_attr ($GLOBALS["WS_PLUGIN__"]["s2member"]["c"]["dir_url"]) . '/images/ajax-loader.gif" alt="" style="display:none;" /></p>' . "\n";
						...
						echo '<li><code>rp="1"</code> Regular Period. Only valid w/ Membership Level Access. Must be &gt;= <code>1</code> ( ex: <code>1</code> Week, <code>2</code> Months, <code>1</code> Month, <code>3</code> Days ). <a href="#" onclick="alert(\'With the exception of Fixed-Term Access on Standard Products, this MUST correlate with a Recurring Product that you\\\'ve configured in your ClickBank® account.\'); return false;" tabindex="-1">[?]</a></li>' . "\n";
						echo '<li><code>rt="D"</code> Regular Term. Only valid w/ Membership Level Access. Possible values: <code>D</code> = Days, <code>W</code> = Weeks, <code>M</code> = Months, <code>Y</code> = Years, <code>L</code> = Lifetime. <a href="#" onclick="alert(\'With the exception of Fixed-Term Access on Standard Products, this MUST correlate with a Product that you\\\'ve configured in your ClickBank® account.\'); return false;" tabindex="-1">[?]</a></li>' . "\n";
						echo '<li><code>rr="0"</code> Recurring directive. Only valid w/ Membership Level Access. Possible values: <code>0</code> = "Standard" Product, charge is NOT recurring; <code>1</code> = "Recurring" Product with possible Trial Period, and Rebill charges. <a href="#" onclick="alert(\'This MUST correlate with a Product that you\\\'ve configured in your ClickBank® account.\'); return false;" tabindex="-1">[?]</a></li>' . "\n";
						...
						echo '<li><code>&amp;s2_invoice=1:music,videos:2 D</code> s2Member\'s Item Number for Membership Level Access ( colon separated <code><em>level:custom_capabilities:fixed term</em></code> ) that the Subscription is for.</li>' . "\n";
