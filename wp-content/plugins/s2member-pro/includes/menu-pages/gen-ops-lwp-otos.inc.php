				...
				public function __construct ()
					{
						...
						echo '<code>[#Logins]</code>:<code>[URL to One-Time-Offer page]</code><br /><br />' . "\n";
						echo '<em><code>[#Logins]</code> ( this triggers your One-Time-Offer page, upon login )</em><br />' . "\n";
						...
						echo '<code>1:http://example.com/your-first-login/</code> <em>( displayed on 1st login )</em><br />' . "\n";
						echo '<code>25:http://example.com/customer-loyalty-reward/</code> <em>( displayed on 25th login )</em>' . "\n";
						echo '</td>' . "\n";
						/**/
						echo '</tr>' . "\n";
						echo '</tbody>' . "\n";
