...
jQuery(document).ready (function($)
	{
		...
		/**/
		else if (location.href.match (/page\=ws-plugin--s2member-pro-paypal-forms/))
			{
				...
				/**/
				ws_plugin__s2member_pro_paypalFormGenerate = function(form) /* Handles PayPal® Form Generation. */
					{
						...
						var regRecurTimes = '', regRecurRetries = '2'; /* These options are NOT yet configurable. */
						/**/
				...
				/**/
				ws_plugin__s2member_pro_paypalCcapFormGenerate = function(form) /* Handles PayPal® Form Generation. */
					{
				...
				/**/
				ws_plugin__s2member_pro_paypalSpFormGenerate = function() /* Handles PayPal® Form Generation. */
					{
						var shortCodeTemplate = '[s2Member-Pro-PayPal-Form %%attrs%% accept="paypal,visa,mastercard,amex,discover,maestro,solo" accept_via_paypal="paypal" coupon="" accept_coupons="0" default_country_code="" captcha="0" /]', shortCodeTemplateAttrs = '';
						/**/
				...
				/**/
				ws_plugin__s2member_pro_paypalRegLinkGenerate = function() /* Handles PayPal® Link Generation. */
					{
				...
				/**/
				ws_plugin__s2member_pro_paypalSpLinkGenerate = function() /* Handles PayPal® Link Generation. */
					{
