						...
						if (!is_multisite () || !c_ws_plugin__s2member_utils_conds::is_multisite_farm () || is_main_site ())
							{
								...
								echo '<p>With s2Member Pro installed, you have access to the s2Member Pro Login Widget. This is made available in your Dashboard under: <code>Appearance -> Widgets</code>. Very simple to use; just drag &amp; drop ( that\'s it ). For developers though, sometimes it is necessary to include the Pro Login Widget in non-widgetized sections of a WordPress® theme; or even into another plugin that you run in concert with s2Member. You can use this PHP tag to build the Pro Login Widget dynamically: <code>' . c_ws_plugin__s2member_utils_strings::highlight_php ('<?php echo s2member_pro_login_widget(); ?>') . '</code>. The Pro Login Widget can also be configured with an <em>optional</em> array of <a href="http://www.primothemes.com/forums/viewtopic.php?f=40&t=12453#src_doc_s2member_pro_login_widget%28%29" target="_blank" rel="external">configuration parameters</a>.</p>' . "\n";
								/**/
