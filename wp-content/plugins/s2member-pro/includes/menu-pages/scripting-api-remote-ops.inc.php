						...
						if (!is_multisite () || !c_ws_plugin__s2member_utils_conds::is_multisite_farm () || is_main_site ())
							{
								...
								echo '<input type="text" value="' . format_to_edit (c_ws_plugin__s2member_pro_remote_ops::remote_ops_key_gen ()) . '" style="width:99%;" />' . "\n";
								...
								echo '<p>' . c_ws_plugin__s2member_utils_strings::highlight_php (str_replace ("www.example.com", $_SERVER["HTTP_HOST"], str_replace ("http://www.example.com/", site_url ("/"), str_replace ("[API Key]", c_ws_plugin__s2member_pro_remote_ops::remote_ops_key_gen (), file_get_contents (dirname (__FILE__) . "/code-samples/remote-op-create-user.php"))))) . '</p>' . "\n";
								/**/
