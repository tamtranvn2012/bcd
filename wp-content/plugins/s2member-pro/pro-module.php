...
if (!defined ("WS_PLUGIN__S2MEMBER_PRO_VERSION"))
	define ("WS_PLUGIN__S2MEMBER_PRO_VERSION", "110815");
/**
...
if (!defined ("WS_PLUGIN__S2MEMBER_PRO_MIN_WP_VERSION"))
	define ("WS_PLUGIN__S2MEMBER_PRO_MIN_WP_VERSION", "3.1");
/**
...
if (!defined ("WS_PLUGIN__S2MEMBER_PRO_MIN_FRAMEWORK_VERSION"))
	define ("WS_PLUGIN__S2MEMBER_PRO_MIN_FRAMEWORK_VERSION", "110815");
/*
...
*/
else if (is_admin ()) /* Admin compatibility errors. */
	{
		if (!version_compare (PHP_VERSION, WS_PLUGIN__S2MEMBER_PRO_MIN_PHP_VERSION, ">="))
			...
			{
				add_action ("all_admin_notices", create_function ('', 'echo \'<div class="error fade"><p>In order to load the s2Member Pro Module, you need the <a href="http://www.primothemes.com/post/product/s2member-membership-plugin-with-paypal/" target="_blank">s2Member Framework</a>, v\' . WS_PLUGIN__S2MEMBER_PRO_MIN_FRAMEWORK_VERSION . \'+. It\\\'s free.</p></div>\';'));
			}
		else if (!version_compare (WS_PLUGIN__S2MEMBER_PRO_VERSION, WS_PLUGIN__S2MEMBER_MIN_PRO_VERSION, ">="))
			{
				add_action ("admin_init", "c_ws_plugin__s2member_pro_upgrader::upgrade"); /* Upgrade Hook. */
				include_once dirname (__FILE__) . "/includes/classes/upgrader.inc.php"; /* Include upgrader class. */
				add_action ("all_admin_notices", create_function ('', 'echo \'<div class="error fade"><p>Your <a href="http://www.s2member.com/" target="_blank">s2Member Pro Module</a> must be updated to v\' . WS_PLUGIN__S2MEMBER_MIN_PRO_VERSION . \'+.<br />Please log in at <a href="http://www.s2member.com/" target="_blank" rel="external">s2Member.com</a> for access to the latest version.</p>\' . c_ws_plugin__s2member_pro_upgrader::wizard () . \'</div>\';'));
			}
	}
?>